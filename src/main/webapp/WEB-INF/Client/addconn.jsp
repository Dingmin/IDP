...
<body>
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="control-label">信任系统B</label> <input type="text" name="linkB"
										...
										ng-model="model.email" required="" placeholder="输入关键字：url/系统名/系统负责人姓名" list="bb">
										<datalist id="bb">
								...
								<div class="form-group">
									<div class="checkbox1">
										<label> <input type="checkbox" disabled="" ng-model="model.winner"
	...
	<script type="text/javascript" src="../js/client_addConn.js"></script>
</body>
</html>
