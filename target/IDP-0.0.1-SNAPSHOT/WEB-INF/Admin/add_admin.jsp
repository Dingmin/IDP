...
<body>
						...
						<form
							...
							<fieldset>
								<div class="form-group">
									<label class="control-label">姓名</label> <input type="text" name="realName"
	...
	<script type="text/javascript" src="../js/Admin_add_admin.js"></script>
</body>
</html>
