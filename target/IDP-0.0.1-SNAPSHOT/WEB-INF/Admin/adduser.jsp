...
<body>
					...
					<div class="well1 white">
						<form action="#" method="post"
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="control-label">密码 </label> <input type="password"  name="pwd"
										class="form-control1 ng-invalid ng-invalid-required ng-touched"
										ng-model="model.password" required="" placeholder="至少6位数">
								</div>
								<div class="form-group">
									<label class="control-label">标志</label> <input type="text" name="token"
										class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched"
										ng-model="model.email" required="" placeholder="邮箱/学号。。。">
								</div>
								<div class="form-group">
	...
	<script type="text/javascript" src="../js/Admin_add_user.js"></script>
</body>
</html>
